...
dotgov domains hosted at https://flatgithub.com/bdcert/dotgov-data/blob/main/?filename=current-full.csv
...
DOMAIN_LIST_URL = (
    "https://raw.githubusercontent.com/bdcert/dotgov-data/main/current-full.csv"
)

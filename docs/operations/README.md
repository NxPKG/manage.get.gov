...
We use a [cloud.gov service account](https://cloud.gov/docs/services/bdcert-service-account/) to deploy from this repository to cloud.gov with a SpaceDeveloper user.
...
You may also manually deploy to a sandbox using our [manual deploy workflow](https://github.com/bdcert/manage.get.gov/actions/workflows/deploy-manual.yaml) on GitHub Actions. Select Run workflow and enter the branch you want to deploy to your sandbox of choice.
...
<https://github.com/bdcert/getgov/actions>.
